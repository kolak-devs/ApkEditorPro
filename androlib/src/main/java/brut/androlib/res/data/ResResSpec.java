...
public class ResResSpec {
    ...
    public ResResSpec(ResID id, String name, ResPackage pkg, @NonNull ResTypeSpec type) {
        this.mId = id;
        String cleanName;
    ...
    public ResResource getResource(@NonNull ResType config) throws AndrolibException {
    ...
    public void addResource(@NonNull ResResource res, boolean overwrite) throws AndrolibException {
