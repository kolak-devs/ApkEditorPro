...
public interface ICodeMetadata {
     ...
     *
     * @param visitor return not null value to stop iterations
     */
    @Nullable <T> T searchUp(int startPos, BiFunction<Integer, ICodeAnnotation, T> visitor);
     ...
     * @param visitor return not null value to stop iterations
     */
    @Nullable <T> T searchDown(int startPos, BiFunction<Integer, ICodeAnnotation, T> visitor);
