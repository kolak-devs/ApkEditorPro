...
public class SmaliCodeDialog extends Dialog
    ...
    static String[] smaliName = {"Показать уведомление", "Регистрация сообщения", "Извлечь значение", "Вывод трасировки стека"};
...
//                    "    move-result-object v0",
    ...
    private void init(final Activity activity) {
        View view = LayoutInflater.from(activity).inflate(R.layout.dialog_smali_template, null);

        // Spinner
        Spinner spinner = (Spinner) view.findViewById(R.id.spinner_codename);
        String[] names = new String[smaliName.length];
        System.arraycopy(smaliName, 0, names, 0, smaliName.length);
    ...
    private void copyUtilSmali() {
        String dirPath = smaliRootFolder + "apkeditor";
