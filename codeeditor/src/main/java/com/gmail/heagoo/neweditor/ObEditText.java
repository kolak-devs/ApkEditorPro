...
// ObservableEditText
public class ObEditText extends AppCompatAutoCompleteTextView implements InputMethodWatcher {
	...
	private final int lastColumn = -1;
	private final int lastLine = -1;
...
//	}
	...
	private int getLineEnd(int line) {
		return getLayout().getLineEnd(line) - 1;
	}
	...
	public InputConnection onCreateInputConnection(EditorInfo outAttrs) {
		...
		BaseInputConnection fic = new BaseInputConnection(this, false) {
			public boolean deleteSurroundingText(int beforeLength,
				...
				return super.sendKeyEvent(new KeyEvent(0, 67))
