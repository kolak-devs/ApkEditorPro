...
/**
 * Created by Snow Volf on 03.11.2017, 16:18
 */

public class ShaderText extends AppCompatTextView {
    ...
    public ShaderText(Context context, AttributeSet attrs) {
        super(context, attrs);
