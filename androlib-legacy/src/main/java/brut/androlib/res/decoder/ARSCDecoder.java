...
public class ARSCDecoder {
    ...
    // TODO: FOR APKEDITOR PRO
    //  ResourceIdProvider --> ResSmaliIdProvider
    @NonNull
    @Contract("_, _, _, _, _, _ -> new")
    public static ARSCData decode(InputStream arscStream, boolean findFlagsOffsets, boolean keepBroken,
                                  ResTable resTable, ResSmaliIdProvider idProvider, boolean apkProtected)
            throws AndrolibException {
        try {
    ...
    // TODO: FOR APKEDITOR PRO
    //  ResourceIdProvider --> ResSmaliIdProvider
    private final ResSmaliIdProvider idProvider;
    private boolean[] mIsFileValues;
    private boolean mIsFileValue;
    private final boolean mApkProtected;

    // TODO: FOR APKEDITOR PRO
    //  ResourceIdProvider --> ResSmaliIdProvider
    private ARSCDecoder(InputStream arscStream, ResTable resTable, ResSmaliIdProvider idProvider, boolean storeFlagsOffsets, boolean keepBroken, boolean apkProtected) {
...
//        }
    ...
    private final byte[] perfBuf = new byte[12];
...
//        }
    ...
    private void readEntry(@NonNull EntryData entryData) throws AndrolibException {
...
//            screenHeightDp = mIn.readShort();
    ...
    private void removeResSpec(@NonNull ResResSpec spec) throws AndrolibException {
    ...
    public static class Header {
        ...
        @NonNull
        @Contract("_, _ -> new")
        public static Header read(@NonNull ExtDataInput in, @NonNull CountingInputStream countIn) throws IOException {
            short type;
