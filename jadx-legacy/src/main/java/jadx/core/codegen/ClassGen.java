...
public class ClassGen {
	...
	public static final Comparator<MethodNode> METHOD_LINE_COMPARATOR = new Comparator<MethodNode>() {
		@Override
		public int compare(@NonNull MethodNode a, @NonNull MethodNode b) {
	...
	public ClassGen(ClassNode cls, @NonNull IJadxArgs jadxArgs) {
	...
	public void addClassBody(@NonNull CodeWriter clsCode) throws CodegenException {
		clsCode.add('{');
	...
	private void addInnerClasses(CodeWriter code, @NonNull ClassNode cls) throws CodegenException {
	...
	private void addMethod(CodeWriter code, @NonNull MethodNode mth) throws CodegenException {
	...
	public void useType(CodeWriter code, @NonNull ArgType type) {
	...
	private String useClassInternal(ClassInfo useCls, @NonNull ClassInfo extClsInfo) {
	...
	private static boolean isBothClassesInOneTopClass(@NonNull ClassInfo useCls, @NonNull ClassInfo extClsInfo) {
	...
	private static boolean isClassInnerFor(@NonNull ClassInfo inner, ClassInfo parent) {
		if (inner.isInner()) {
	...
	private void insertSourceFileInfo(CodeWriter code, @NonNull AttrNode node) {
	...
	private void insertRenameInfo(CodeWriter code, @NonNull ClassNode cls) {
