...
public class ConditionGen extends InsnGen {
	...
	public ConditionGen(@NonNull InsnGen insnGen) {
	...
	private void add(CodeWriter code, @NonNull CondStack stack, IfCondition condition) throws CodegenException {
	...
	private void addCompare(CodeWriter code, CondStack stack, @NonNull Compare compare) throws CodegenException {
	...
	private void addTernary(CodeWriter code, CondStack stack, @NonNull IfCondition condition) throws CodegenException {
	...
	private void addNot(@NonNull CodeWriter code, CondStack stack, @NonNull IfCondition condition) throws CodegenException {
		code.add('!');
		wrap(code, stack, condition.getArgs().get(0));
	}

	private void addAndOr(CodeWriter code, CondStack stack, @NonNull IfCondition condition) throws CodegenException {
	...
	private boolean isWrapNeeded(@NonNull IfCondition condition) {
	...
	private static boolean isArgWrapNeeded(@NonNull InsnArg arg) {
		if (!arg.isInsnWrap()) {
			return false;
		}
