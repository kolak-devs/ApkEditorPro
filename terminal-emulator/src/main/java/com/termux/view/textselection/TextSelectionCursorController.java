...
public class TextSelectionCursorController implements CursorController {
  ...
  public void setInitialTextSelectionPosition(MotionEvent event) {
    ...
    int cy =
        (int) ((event.getY() + SELECT_TEXT_OFFSET_Y) / terminalView.mRenderer.getFontLineSpacing())
        ...
        new ActionMode.Callback() {
          ...
          public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
            ...
            switch (item.getItemId()) {
              case ACTION_COPY:
                String selectedText =
                    terminalView.mEmulator.getSelectedText(mSelX1, mSelY1, mSelX2, mSelY2).trim();
              ...
              case ACTION_PASTE:
                ...
                break;
              case ACTION_MORE:
                terminalView.stopTextSelectionMode(); // we stop text selection first,
                // otherwise handles
