...
import com.mcal.common.utilsOld.ScopedStorage;
...
public final class Environment {
    ...
    public static void init() {
        ...
        PROJECTS_DIR = mkdirIfNotExits(new File(ScopedStorage.getExternalStoragePath(), PROJECTS_FOLDER));
        ...
        if (!JAVA_HOME.exists()) {
            final File java_home = new File(HOME, "jdk");
            if (java_home.exists()) {
                JAVA_HOME = java_home;
            }
        }
    ...
    private static Map<String, String> readProperties() {
        ...
        try {
            ...
            Log.e("ERROR", "Unable to read properties file " + th.getMessage());
        }
        return props;
    }
    ...
    public static void setExecutable(@NonNull final File file) {
        if (!file.setExecutable(true)) {
            Log.e("ERROR", "Unable to set executable permissions to file " + file);
        }
    }
    ...
    public static boolean isCompilerModuleInstalled() {
        final File modules = new File(COMPILER_MODULE, "lib/modules");
        final File release = new File(COMPILER_MODULE, "release");
