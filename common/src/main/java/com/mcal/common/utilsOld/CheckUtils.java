...
public class CheckUtils {
    ...
    public static byte[] getSign(@NonNull Context context) {
    ...
    public static String getSign(@NonNull Context context, String packageName) {
        PackageManager pm = context.getPackageManager();

        return getSign(pm, packageName);
    }

    public static String getSign(@NonNull PackageManager pm, String packageName) {
        String sign = null;
