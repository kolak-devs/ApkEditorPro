...
public class ImageTool {
    ...
    public void zoomToSmaller(@NonNull Context ctx, String srcFile, String dstFile,
    ...
    @NonNull
    private byte[] bitmap2Bytes(@NonNull Bitmap bitmap) {
    ...
    public void zoomImage(@NonNull Bitmap bitmap, int width, int height,
                          String outFilePath) {
