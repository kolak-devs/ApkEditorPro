...
package ru.mcal.manifestparser.xml;
...
import ru.mcal.manifestparser.IAbstractFile;
import ru.mcal.manifestparser.SdkConstants;
import ru.mcal.manifestparser.StreamException;
import ru.mcal.manifestparser.resources.Keyboard;
import ru.mcal.manifestparser.resources.Navigation;
import ru.mcal.manifestparser.resources.TouchScreen;
                    ...
                    switch (mValidLevel) {
                        ...
                        case LEVEL_INSIDE_MANIFEST:
                            if (AndroidManifest.NODE_APPLICATION.equals(localName)) {
                                ...
                                mManifestData.mApplication = getAttributeValue(
