...
public class CustomSignDialog implements DialogInterface.OnClickListener {
    ...
    @Contract(pure = true)
    public CustomSignDialog(Context context, DialogInterface.OnClickListener listener) {
    ...
    public void show() {
        ...
        @SuppressLint("InflateParams") View view = LayoutInflater.from(context).inflate(R.layout.dialog_keystore_jks, null);

        AppCompatEditText keyStorePath = view.findViewById(R.id.keystore_path);
        AppCompatEditText keyStoreAlias = view.findViewById(R.id.keystore_alias);
        AppCompatEditText keyStorePass = view.findViewById(R.id.keystore_pass);
        AppCompatEditText certPassword = view.findViewById(R.id.cert_password);
        ...
        pickerDialog = new FilePickerDialog(context, properties);
        ...
        pickerDialog.setNegativeBtnName(context.getString(android.R.string.cancel));
