...
public class AxmlEditActivity extends CustomizedLangActivity implements IDirChanged, View.OnClickListener {
        ...
        if (requestCode == 0) {
            ...
            if (resultCode == 1) {
                ...
                new ProgressDialog(this, "", "Working…", false,
                        new XmlCompiler(filePath, entryName), -1).show();
            }
        }
    }
    ...
    private void initViews() {
        ...
        this.summaryTv = findViewById(R.id.tv_summary);
    ...
    private class XmlCompiler implements ProgressDialog.ProcessingInterface {
