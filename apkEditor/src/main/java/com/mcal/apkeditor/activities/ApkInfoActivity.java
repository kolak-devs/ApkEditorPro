...
public class ApkInfoActivity extends CustomizedLangActivity
    ...
    private void recoverData(@NonNull Bundle savedInstanceState) {
        ...
        searchTextContent = savedInstanceState
...
//            break;
            ...
            case RC_OPEN_BEFORE_REPLACE:
                ...
                if ((decodeRootPath + "/AndroidManifest.xml").equals(savedParam_extraStr)) { // AnfroidManifest
                    setManifestModified(true);
                }
    ...
    private void initView() {
        ...
        this.stringLayout = this.findViewById(R.id.string_layout);
        ListView stringList = this.findViewById(R.id.string_list);
        this.resourceLayout = this.findViewById(R.id.resource_layout);
        ...
        this.resNaviHeader = findViewById(R.id.res_header_navigation);
        this.resSelectHeader = findViewById(R.id.res_header_selection);
        this.navigationMgr = new ResNavigationMgr(this, this.decodeRootPath, resNaviHeader, resNaviScrollView);
        this.resSelectTip = findViewById(R.id.selection_tip);

        this.manifestLayout = this.findViewById(R.id.manifest_layout);
        this.manifestList = this.findViewById(R.id.manifest_list);
        this.loadingLayout = this.findViewById(R.id.layout_loading);
        ...
        if (SettingActivity.isDex2smaliEnabled(this)) {
            ...
            this.decodeProgressBar = findViewById(R.id.progressbar_dex2smali);
            this.decodeResultLayout = findViewById(R.id.decode_result_layout);
            this.decodeResultTitle = findViewById(R.id.decode_result_title);
            this.decodeResultDetail = findViewById(R.id.decode_result_detail);
        ...
        // File search option
        this.searchOptionImage = findViewById(R.id.imageview_text_check);
        this.searchOptionCase = findViewById(R.id.imageview_insensitive_check);
        updateSearchOption();

        // keyword auto complete
        AutoCompleteTextView editView = findViewById(R.id.keyword_edit);
        this.strKeywordAdapter = new AutoCompleteAdapter(this, "string_keywords");
        editView.setAdapter(strKeywordAdapter);
        editView = findViewById(R.id.et_res_keyword);
        this.resKeywordAdapter = new AutoCompleteAdapter(this, "res_keywords");
        editView.setAdapter(resKeywordAdapter);
        editView = findViewById(R.id.mf_keyword);
        this.mfKeywordAdapter = new AutoCompleteAdapter(this, "mf_keywords");
    ...
    private void setupMfSearch() {
        ImageButton btn = this.findViewById(R.id.btn_search_mf);
...
//        }
    ...
    private void showStringList() {
        ...
        // Searcher
        ImageButton searchBtn = this.findViewById(R.id.search_button);
    ...
    private void initAddLanguageBtn() {
        ImageButton iv = this.findViewById(R.id.add_language);
    ...
    private void initTranslateBtn() {
        ImageButton iv = this.findViewById(R.id.translate);
...
//                }
    ...
    private String extractFileFromZip(@NonNull String entryName) {
        ...
        String dstPath;
        try {
            String zipEntry = fileEntry2ZipEntry.get(entryName);
