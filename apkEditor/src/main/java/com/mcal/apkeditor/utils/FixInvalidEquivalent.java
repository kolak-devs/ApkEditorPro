...
// /data/user/0/com.mcal.apkeditor.pro/files/decoded/res/anim/aRA.xml: error: File is case-insensitive equivalent to: /data/user/0/com.mcal.apkeditor.pro/files/decoded/res/anim/aRa.xml
        ...
        try {
            ...
            for (int i = 0; i < lines.size(); ++i) {
                ...
                if (!recordResourceName(resType, lcName)) {
                    String newName = resName + "_" + getRandomString(6);
