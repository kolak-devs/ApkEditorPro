...
public class ApkDecoderMine implements IReferenceDecode, Logger {
    ...
    public ApkDecoderMine(ResTable resTable, byte[] dummyPng, byte[] dummyJpg) {
        ...
        this.xmlDecoder = new XmlDecoder(getResPackage());
    ...
    public void decode(@NonNull Activity activity, String apkPath, String decodeRootPath) {
        ...
        try {
            ...
            Androlib lib = new Androlib(options, this);
    ...
    public void decode(@NonNull ExtFile apkFile, File outDir) throws Exception {
        ...
        if (!stopRunning) {
            String packageName = decodeManifest(apkFile, outDir);
        }
