...
public class RebuildConfirmDialog {
    ...
    private final boolean stringModified;
    private final boolean manifestModified;
    // Checkbox in UI
    ...
    private void initData(@NonNull Map<String, String> added,
                          Map<String, String> replaced, Set<String> deleted) {
    ...
    public void show() {
        ...
        View layout = LayoutInflater.from(ctx)
                .inflate(R.layout.dialog_rebuild_confirm, null);
