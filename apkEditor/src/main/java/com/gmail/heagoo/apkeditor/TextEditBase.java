...
import com.gmail.heagoo.apkeditor.pro.JavaExtractor;
import com.gmail.heagoo.apkeditor.dialogs.LinesOpDialogHelper;
import com.gmail.heagoo.apkeditor.dialogs.ProcessingDialog;
import com.gmail.heagoo.apkeditor.dialogs.SmaliCodeDialog;
import com.gmail.heagoo.apkeditor.dialogs.SmaliMethodsDialogs;
...
public abstract class TextEditBase extends CustomizedLangActivity implements ColorMixer.OnColorChangedListener, SmaliMethodsDialogs.ISmaliMethodClicked, LinesOpDialogHelper.ILinesOperation {
    // For big file or not
    private final boolean isForBigFile;
    // Fix the Android bug or not
    private final boolean fixBug;
    // For bottom menu
    private final String[] specialStrings = {
            ",.?!:;~-_=\"'/@*+()<>{}[]%&$|\\#^",
            "<>\":=/@+.-?#_()[]{}\\;!$%^&*|~',",
            "(){};.=\"'|&![]@<>+-*/?:,_\\^%#~$",
    };
    ...
    @Contract(pure = true)
    public static boolean isXml(@NonNull String filePath) {
