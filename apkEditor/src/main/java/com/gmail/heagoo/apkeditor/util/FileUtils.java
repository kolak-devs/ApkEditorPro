...
public class FileUtils {
    ...
    public static String makeDir(Context ctx, String dirName) throws Exception {
        ...
        if (packagePath.startsWith("com.gmail.heagoo.apkeditor.apkpermremover")) {
            subDir = "/.ApkPermRemover/" + dirName + "/";
        } else if (packagePath.startsWith("com.gmail.heagoo.apkeditor.pmaster")) {
            subDir = "/PermMaster/" + dirName + "/";
        } else if (packagePath.equals("com.gmail.heagoo.apkeditor.permissionmanager")) {
            subDir = "/PermMaster/" + dirName + "/";
        } else if (packagePath.startsWith("com.gmail.heagoo.apkeditor")) {
            subDir = "/ApkEditor/" + dirName + "/";
        } else if (packagePath.startsWith("com.gmail.heagoo.apkeditor.appdm")) {
            subDir = "/HackAppData/" + dirName + "/";
        } else if (packagePath.startsWith("com.gmail.heagoo.apkeditor.pro")) {
            subDir = "/ApkEditor/" + dirName + "/";
        } else if (packagePath.startsWith("com.gmail.heagoo.apkeditor.legacy")) {
            subDir = "/ApkEditor/" + dirName + "/";
        }
