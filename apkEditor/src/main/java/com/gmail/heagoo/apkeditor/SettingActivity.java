...
public class SettingActivity extends AppCompatActivity {
    ...
    public static int getFileRenameOption(Context ctx) {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(ctx);
        String strOption = sp.getString(fileRenameKey, "" + EXTRACT_AUTORENAME);
        try {
            return Integer.valueOf(strOption);
        } catch (Exception e) {
            return EXTRACT_AUTORENAME;
        }
    }
    ...
    public static class SettingsFragment extends PreferenceFragment
        ...
        private void initData() {
            ...
            // Decode mode
            {
                ...
                String value = getDecodeMode(activity);
            ...
            // Full screen
            {
                ...
                boolean b = GlobalConfig.instance(activity).isFullScreen();
                ...
                checkBox.setOnPreferenceChangeListener(
                        new OnPreferenceChangeListener() {
                            ...
                            public boolean onPreferenceChange(Preference arg0,
                                                              Object newValue) {
                                GlobalConfig.instance(activity)
                                        .setFullScreen(activity, (Boolean) newValue);
                                return true;
                            }
                        });
            }
            ...
            // App Theme
            {
                ...
                int id = GlobalConfig.instance(activity).getThemeId();
            ...
            // Language
            {
                ...
                String language =
                        PreferenceManager.getDefaultSharedPreferences(activity).getString(key, "");
            ...
            if (isFreeVersion()) {
                ...
                boolean b = isDex2smaliEnabled(activity);
            ...
            // Rebuild confirmation
            {
                CheckBoxPreference confirmPref = (CheckBoxPreference) findPreference(
                        confirmEnabledKey);
                boolean enabled = isRebuildConfirmEnabled(activity);
            ...
            // The main purpose for this is to set the default value
            {
                ...
                int option = getFileRenameOption(activity);
            ...
            if (!BuildConfig.IS_PRO) {
                ...
                String decodeDir = getDecodeDirectory(activity);
                if (decodeDir != null) {
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            // App theme
                ...
                try {
                    ...
                    GlobalConfig.instance(context).updateThemeId(themeId);
        ...
        public boolean onPreferenceClick(Preference preference) {
            ...
            if (cleanKey.equals(clickedKey)) {
                ProcessingDialog dlg = new ProcessingDialog(activity,
                        new ProcessingInterface() {
                            @Override
                            public void process() throws Exception {
                                activity.cleanSdcard();
