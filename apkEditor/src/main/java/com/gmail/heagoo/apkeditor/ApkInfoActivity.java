...
import com.gmail.heagoo.apkeditor.adapters.IManifestChangeCallback;
import com.gmail.heagoo.apkeditor.adapters.LineRecord;
import com.gmail.heagoo.apkeditor.adapters.ManifestListAdapter;
import com.gmail.heagoo.apkeditor.dialogs.AboutPluginDialog;
import com.gmail.heagoo.apkeditor.dialogs.FileCopyDialog;
import com.gmail.heagoo.apkeditor.dialogs.FileSelectDialog;
import com.gmail.heagoo.apkeditor.dialogs.FileSelectDialog.IFileSelection;
import com.gmail.heagoo.apkeditor.dialogs.LanguageSelectDialog;
import com.gmail.heagoo.apkeditor.dialogs.PatchDialog;
import com.gmail.heagoo.apkeditor.dialogs.ProcessingDialog;
import com.gmail.heagoo.apkeditor.dialogs.RebuildConfirmDialog;
import com.gmail.heagoo.apkeditor.dialogs.SearchFilenameDialog;
import com.gmail.heagoo.apkeditor.dialogs.SearchTextDialog;
import com.gmail.heagoo.apkeditor.dialogs.SmaliNoticeDialog;
...
public class ApkInfoActivity extends CustomizedLangActivity
    ...
    private AppCompatButton dex2smaliImage;
    private ContentLoadingProgressBar decodeProgressBar;
...
//            dlg.setMessage(message);
            ...
            dlg.setNeutralButton(R.string.save_as_project, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    saveAsProject();
                }
...
//            break;
    ...
    private void initView() {
        ...
        this.apkPkgPath = this.findViewById(R.id.app_pkgpath);
        ...
        this.stringLayout = this
                .findViewById(R.id.string_layout);
        this.stringList = this.findViewById(R.id.string_list);
        this.resourceLayout = this
                .findViewById(R.id.resource_layout);
        this.resourceList = this.findViewById(R.id.resource_list);
        ...
        this.resNaviScrollView = findViewById(
                R.id.res_navi_scrollView);
        this.resNaviHeader = findViewById(
        ...
        this.resSelectTip = findViewById(R.id.selection_tip);

        this.manifestLayout = this
                .findViewById(R.id.manifest_layout);
        this.manifestList = this.findViewById(R.id.manifest_list);
        ...
        // File search option
        this.searchOptionImage = findViewById(
                R.id.imageview_text_check);
        this.searchOptionCase = findViewById(
    ...
    private void updateSearchOption() {
        int txtId = -1;
        int caseId = -1;
        txtId = searchTextContent ? R.drawable.round_feed_24
                : R.drawable.round_feed_blue_24;
        caseId = searchResSensitive ? R.drawable.round_text_format_blue_24
    ...
    private void setupMfSearch() {
        AppCompatImageButton btn = this.findViewById(R.id.btn_search_mf);
    ...
    public void onClick(View v) {
        ...
        // Search keyword in AndroidManifest.xml
            ...
            EditText et = this.findViewById(R.id.mf_keyword);
        ...
        // Search in resource
            ...
            EditText et = this.findViewById(R.id.et_res_keyword);
            String keyword = et.getText().toString();
            keyword = keyword.trim();
            if (keyword.equals("")) {
                Toast.makeText(this, R.string.empty_input_tip,
...
//        }
    ...
    private void showStringList() {
        ...
        // Searcher
        AppCompatImageButton searchBtn = this.findViewById(R.id.search_button);
    ...
    private void initTranslateBtn() {
        AppCompatImageButton iv = this.findViewById(R.id.translate);
...
//            addedConfigFlag = createConfigFlags(qualifier);
    ...
    private void showDecodedFileList() {
        ...
        resListAdapter = new ResListAdapter(this, path, curDir,
                decodeRootPath, this.fileEntry2ZipEntry, new FilenameFilter() {
            @Override
