...
import com.gmail.heagoo.apkeditor.dialogs.ProcessingDialog.ProcessingInterface;
...
public class TextEditNormalActivity extends TextEditBase
    ...
    private final int highlightSize = 20;
    ...
    public static boolean isValuesXml(String filePath) {
        ...
        if (folders.length > 2) {
            ...
            return folder.startsWith("values");
        }
        return false;
    }
    ...
    private void initMainView() {
        // File name title
        this.filenameTv = this.findViewById(R.id.filename);
    ...
    private void initEditView() {
        this.editorInnerLayout = findViewById(R.id.editorLayout);
        this.editorOuterLayout = findViewById(R.id.center_layout);
        this.lineNumbers = findViewById(R.id.lineNumbers);
        // Remove the max characters limitation
        lineNumbers.setFilters(new InputFilter[]{});
        this.textEditor = findViewById(R.id.editor);
        textEditor.setFilters(new InputFilter[]{});
        this.lineDivider = findViewById(R.id.divider);
        this.editorScrollView = findViewById(R.id.editorScrollview);
        this.editorHorizontalLayout = findViewById(R.id.hScrollView);
        this.docFindAnim = findViewById(R.id.searchAnimator);
        this.documentListDrawer = findViewById(R.id.sliding_drawer);
        this.findText = findViewById(R.id.findEdit);
        this.replaceText = findViewById(R.id.replaceEdit);
        this.findButton = findViewById(R.id.findBtn);
        this.replaceButton = findViewById(R.id.replaceBtn);
        this.replaceAllButton = findViewById(R.id.replaceAllBtn);
        this.openFindButton = findViewById(R.id.openFindBtn);
        this.toggleIgnoreCase = findViewById(R.id.checkBoxIgnoreCase);
        this.toggleRegularExpression = findViewById(R.id.checkBoxRegexp);
        this.saveFileButton = findViewById(R.id.saveBtn);
        this.copyButton = findViewById(R.id.copyBtn);
        this.pasteButton = findViewById(R.id.pasteBtn);
        this.moreButton = findViewById(R.id.moreBtn);
        this.goButton = findViewById(R.id.goBtn);
        this.lineNumEdit = findViewById(R.id.lineNumEdit);
        this.editorLayout = this.editorInnerLayout;
        this.documentListButton = findViewById(R.id.panel_button);
...
//                            .append("9").toString();
    ...
    private void updateCopyState(int selStart, int selEnd) {
        enableButton(copyButton, selStart != selEnd);
    }
...
//        }
    ...
    private void adjustOpenedDrawer() {
        ...
        this.documentListButton.setImageResource(R.drawable.round_chevron_right_24);
    }
    ...
    private void adjustClosedDrawer() {
        ...
        this.documentListButton.setImageResource(R.drawable.round_chevron_left_24);
