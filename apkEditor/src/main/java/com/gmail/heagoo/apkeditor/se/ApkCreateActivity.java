...
public class ApkCreateActivity extends CustomizedLangActivity implements OnClickListener,
    ...
    private void displayResult() {
        if (succeed) {
            ...
            resultImg.setImageResource(R.drawable.round_done_green_24);
        }

        // Failed
        else {
            resultImg.setImageResource(R.drawable.round_close_red_24);
    ...
    public void onClick(@NonNull View v) {
        ...
        // Install
            ...
            ApkInstaller.install(this, outApkPath);
        }
    ...
    private static class CreatingThread extends Thread {
        ...
        @Contract(pure = true)
        private boolean toModifyAppName(@NonNull ApkCreateActivity activity) {
        ...
        private void closeQuietly(@NonNull ZipFile zfile) {
            try {
                zfile.close();
