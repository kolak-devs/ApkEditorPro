...
public class FSNavigator
    ...
    private String ifAvailable(@NonNull String goTo) {
    ...
    @NonNull
    private LinearLayout directoryEntry(@NonNull final String name) {
...
//    titleView.setSelected(true);
    ...
    String getCanonicalPath(@NonNull File file) {
        try {
